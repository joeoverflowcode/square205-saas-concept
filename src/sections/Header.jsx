        ...
        <div className={clsx("w-full max-lg:fixed max-lg:top-0 max-lg:left-0 mag-lg:w-full max-lg:bg-s2 max-lg:opacity-0", isOpen ? "max-lg:opacity-100": "max-lg:pointer-events-none")}>
          <div className="max-lg:relative max-lg:flex max-lg:flex-col max-lg:min-h-screen max-lg:p-6 max-lg:overflow-hidden sidebar-before max-md:px-4">
            ...
            <div className="lg:hidden block absolute top-1/2 left-0 w-[960px] h-[380px] translate-x-[-290px] -translate-y-1/2 rotate-90">
                <img src={`${import.meta.env.BASE_URL}/images/bg-outlines.svg`} width={960} height={380} alt="outline" className="relative z-2"/>
                <img src={`${import.meta.env.BASE_URL}/images/bg-outlines-fill.png`} width={960} height={380} alt="outline" className="absolute inset-0 mix-blend-soft-light opacity-5"/>
            </div>
          </div>
        </div>
